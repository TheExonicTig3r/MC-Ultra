...
public class ItemArmor extends Item
{
    ...
    public static enum ArmorMaterial
    {
        ...
        EMERALD("EMERALD", 5, "emerald", 40, new int[]{4, 9, 7, 4}, 8);
        private final String field_179243_f;
        private final int maxDamageFactor;
        private final int[] damageReductionAmountArray;
        private final int enchantability;

        private static final ItemArmor.ArmorMaterial[] $VALUES = new ItemArmor.ArmorMaterial[]{LEATHER, CHAIN, IRON, GOLD, DIAMOND, EMERALD};
        ...
        {
            return this == LEATHER ? Items.leather : (this == CHAIN ? Items.iron_ingot : (this == GOLD ? Items.gold_ingot : (this == IRON ? Items.iron_ingot : (this == DIAMOND ? Items.diamond : (this == EMERALD ? Items.emerald : null)))));
        }
